    ...
    <MainTemplate>
      <Container>
        <GenericHtml>
          ...
          <img
            src="https://placehold.co/1920x1080?text=Ilustração+Técnica+Pomodoro"
            alt="Ilustração da Técnica Pomodoro com ciclos de foco e pausas"
          />
          ...
          <p>
            ...
            <a href="/settings" data-discover="true">
          ...
          <p>
            ...
            <a href="/history" data-discover="true">
              histórico
            </a>
      ...
      <footer className="_footer_1ciqd_1">
        <div className="_aboutPomodoro_1ciqd_12">
          <a href="/about-pomodoro" data-discover="true">
            Entenda a técnica pomodoro 🍅
          </a>
        </div>
        <div className="_copyright_1ciqd_11">
          <a href="/" data-discover="true">
            Chronos Pomodoro © 2026 - Feito com 💚
          </a>
        </div>
      </footer>
    </MainTemplate>
